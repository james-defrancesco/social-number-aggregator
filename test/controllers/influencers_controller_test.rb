...
class InfluencersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create influencer" do
    assert_difference('Influencer.count') do
      post influencers_url, params: { influencer: { facebook: @influencer.facebook, full_name: @influencer.full_name, instagram: @influencer.instagram, twitter: @influencer.twitter, youtube: @influencer.youtube } }
    end
  ...
  test "should update influencer" do
    patch influencer_url(@influencer), params: { influencer: { facebook: @influencer.facebook, full_name: @influencer.full_name, instagram: @influencer.instagram, twitter: @influencer.twitter, youtube: @influencer.youtube } }
